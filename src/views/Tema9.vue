...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p Este tipo de documentación contiene información sobre las especificaciones de los productos enlistados, así como sus precios, tiempos de entrega y/o lugares donde se pueden adquirir. Una gran desventaja que poseen los catálogos es que no se actualizan con la frecuencia ideal.
    .col-lg-6.mx-auto
    ...
    .row(data-aos="fade-left")
      ...
      .col-lg-4
        img(src="@/assets/curso/t9/f1.svg" alt="bolsa con medicamentos")
